...
.neon-white-orange {
	color: white;
	text-shadow: 0 0 2px #fff, 0 0 5px #ffa500, 0 0 10px #ffa500, 0 0 20px
		#ffa500;
	font-weight: bold;
...
<body class="playstation">
	<%
	request.setAttribute("currentPage", "playstation");
	%>
	<%
	...
	<section class="container text-center my-5">
		<h1 class="neon-blue">Benvenuto su PZ Store</h1>
		<p>Scopri una vasta gamma di giochi per la tua PlayStation!</p>
	</section>


	<section id="catalogo" class="container text-center my-5">
		<h2 class="fw-bold neon-white-blue">Catalogo Videogiochi PZ</h2>
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<a href="gioco?id=<%=gioco.getId()%>"
							class="btn btn-primary w-100 mb-2">Info</a> <input type="hidden"
...
keyframes pulsate { 100% {
	text-shadow: 0 0 4px #0df, 0 0 11px #0df, 0 0 19px #0df, 0 0 40px #0df,
		0 0 80px #0df, 0 0 90px #0df, 0 0 100px #0df, 0 0 150px #0df;
}
</style>
</body>
</html>